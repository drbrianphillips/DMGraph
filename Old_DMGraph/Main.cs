...
{//Open Namespace
    ...
    {//Open Main Class
        ...
        //CSV Export Date List
        private List<string> csvDateList;
        ...
        private PointPairList Obs1List;
        private PointPairList Obs2List;
        private PointPairList Obs3List;
       ...
       // private PointPairList CumulativePreWTList;
        ...
        string sOnLoad;
        string stextObs1Label;
        string stextObs2Label;
        string stextObs3Label;
        string stextObs1Color;
        string stextObs2Color;
        string stextObs3Color;
       ...
       // private BarItem YearlySurfaceStorageBar;
        ...
        private StreamWriter m2_CSVWriter;
        private StreamWriter m3_CSVWriter;
        private StreamWriter m4_CSVWriter;
      ...
      //*************************************************
        ...
        //*************************************************
        //*************************************************
        //Form Startup Procedures and Initialize Graph
        //*************************************************
        ...
        {
            //Window Position saved from last use
            ...
            //if (File.Exists("C:/DM_Info.dat"))
            //{
                //Create directory if need be
                if (!Directory.Exists("graphing"))
                {   
                    Directory.CreateDirectory("graphing");
                }   

                //Create Preference Files if Need be
                methodCreateFile();

               //Set sOnLoad to YES to indicate new loading of program
                sOnLoad = "YES";

                ////Write LOAD to onload.dat file
                //using (StreamWriter swLoad = new StreamWriter("Graphing/Onload.dat"))
                //{
                //    swLoad.WriteLine("LOAD");
                ...
                ////Declare dialog box variable
                //DialogResult result;
                ////Show messagebox
                //result = MessageBox.Show("Load in Data?", "Graphing Startup", MessageBoxButtons.OKCancel);
            ...
            //else
            //{
            //    MessageBox.Show("The data files were not located." +
            //        "\n\nPlease perform a DRAINMOD simulation." +
            //        "\n\nMake sure to check the Output Option for Daily Hydrology Plot Files", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            //Watch Cancel.dat file for changes
            //This file will change when preferences are changed
           // FileSystemWatcher watcher = new FileSystemWatcher();
            //watcher.Path ="graphing";
            //watcher.Filter = "Time.dat";
        ...
        //Handle if preferences change
        //void watcher_Changed(object sender, FileSystemEventArgs e)
        //{
            //Thread.Sleep(500);//Let files complete writing process and be released from preference form
        ...
        #region "Graphing Section - Initialize Zedgraph"
        ...
        private void Scrolling_Setup(ZedGraphControl zgc)
        {
            ...
            #region "Depracated - Old Initial Startup and Loading of Data Points - Was moved to method"
           ...
           // StreamReader inFile = new StreamReader("graphing/StartupD.dat");
           ...
           //     StreamReader inFileM = new StreamReader("graphing/StartupM.dat");
           ...
           //     StreamReader inFileY = new StreamReader("graphing/StartupY.dat");
        ...
        private void SetSize()
        {
            ...
            zg1.Size = new Size(ClientRectangle.Width - 20, panel1.Height-13);
        ...
        #region "Major Load - Major Loading of Data Points Associated with Info.dat file"
        ...
        private void methodMajorLoad()
        {
            ...
            //{
                ...
                if (!File.Exists("DM_Info.dat"))
                {
                    MessageBox.Show("The data files were not located." +
                    "\n\nPlease perform a DRAINMOD simulation." +
                    "\n\nMake sure to check the Output Option for Daily Hydrology Plot Files" + 
                    "\n\nContact Brian Phillips (brian_phillips@ncsu.edu)" +
                    "\nif the file 'DM_Info.dat' is not generated.",
                ...
                //Open C:/Info.dat file. This file has full path to raw data files
                StreamReader InfoDat = new StreamReader("DM_Info.dat");
                string sGrdPath = InfoDat.ReadLine();
                string sGrmPath = InfoDat.ReadLine();
                string sGryPath = InfoDat.ReadLine();
                InfoDat.Close();
                ...
                while ((line = inFile.ReadLine()) != null)
                {
                    ...
                    //Create Date List for writing to CSV file
                    //DateTime csvDate = new DateTime(iYear, iMonth, iDay);
                    string csvDate = Convert.ToString(iMonth) + "/" + Convert.ToString(iDay) + "/" +
                    ...
                    //Begin cumulative summing at start of year
                    if (iMonth == 1 && iDay == 1)
                    {
                        cRainfall = dRainfall;
                        cInfiltration = dInfiltration;
                    ...
                    //Otherwise add todays value to running total
                    else
                    {
                        cRainfall = cRainfall + dRainfall;
                        cInfiltration = cInfiltration + dInfiltration;
                    ...
                    WaterLossList.Add(dDate, dWaterLoss);
                    SurfaceStorageList.Add(dDate, dSurfaceStorage);
                    //Add Daily Values to Cumulative Lists
                    CumulativeRainfallList.Add(dDate, cRainfall);
                    CumulativeInfiltrationList.Add(dDate, cInfiltration);
                    CumulativeAETList.Add(dDate, cAET);
                    CumulativeDrainageList.Add(dDate, cDrainage);
                ...
                //{
                    ...
                    //stextObs2Label = "";
                    //stextObs3Label = "";
                    //stextObs1Color = "Black";
                    //stextObs2Color = "Black";
                    //stextObs3Color = "Black";

                    string sFileObserved_Paths = "Graphing/Observed_Paths.dat";
                    if (File.Exists(sFileObserved_Paths))
                    {
                        //Read in Observed_Paths.dat in to Text Boxes
                        methodLoadFilePath();

                        //Set or Reset Observed Data Lists - This does not create curves!!
                        if (this.textObsFile.Text != "")
                        {
                            try
                            {
                                methodLoadInObserved1();
                                myCurveObs = zg1.GraphPane.AddCurve("Empty", ObsWTList, Color.Black);
                                myBarObs = zg1.GraphPane.AddBar("Empty", ObsWTList, Color.Black);
                                myCurveObs.Label.Text = this.textObsFile.Text;
                                myBarObs.Label.Text = this.textObsFile.Text;
                            ...
                            {
                                MessageBox.Show("Observed File 1 Format Incorrect.  See Help File.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        ...
                        if (this.textObsFile2.Text != "")
                        {
                            ...
                            {
                            methodLoadInObserved2();
                            myCurveObs2 = zg1.GraphPane.AddCurve("Empty",ObsWTList2, Color.Black);
                            myBarObs2 = zg1.GraphPane.AddBar("Empty", ObsWTList2, Color.Black);
                            myCurveObs2.Label.Text = this.textObsFile.Text;
                            myBarObs2.Label.Text = this.textObsFile.Text;
                            ...
                            {
                                MessageBox.Show("Observed File 2 Format Incorrect.  See Help File.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        ...
                        if (this.textObsFile3.Text != "")
                        {
                            ...
                            {
                                methodLoadInObserved3();
                                myCurveObs3 = zg1.GraphPane.AddCurve("Empty", ObsWTList3, Color.Black);
                                myBarObs3 = zg1.GraphPane.AddBar("Empty", ObsWTList3, Color.Black);
                                myCurveObs3.Label.Text = this.textObsFile.Text;
                                myBarObs3.Label.Text = this.textObsFile.Text;
                            ...
                            {
                                MessageBox.Show("Observed File 3 Format Incorrect.  See Help File.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                #region "Depracated - Create Dummy OBS Curves"
                ...
                //StreamReader inFileO = new StreamReader("graphing/StartupY.dat");

                //// Instantiate data points lists
                //Obs1List = new PointPairList();
                //Obs2List = new PointPairList();
                //Obs3List = new PointPairList();

                //string lineO;

                //// Read one line of data at a time until the end of file
                //while ((lineO = inFileO.ReadLine()) != null)
                //{
                //    // Convert each line in to an array of strings
                //    //Each loop through overwrites previous array
                //    //Split the items on the line using the , character as delimiter (declared above)
                //    string[] itemsO = lineO.Split(sep);
                //    // If there's less than 2 items, throw an exception
                //    if (itemsO.Length < 2)
                //        throw new Exception("Error: Not enough data points to plot");

                //    //Declare Variables in GRH file
                //    double dYearO, dRainfallO, dInfiltrationO, dAETO, dDrainageO;
                //    double dRunoffO, dSEWO, dWaterLossO, dPumpVolO;

                //    // If the value is missing mark it so. Otherwise, parse it as a double
                //    if (itemsO[0].Length == 0)
                //        dYearO = PointPair.Missing;
                //    else
                //        dYearO = Double.Parse(itemsO[0]);

                //    if (itemsO[1].Length == 0)
                //        dRainfallO = PointPair.Missing;
                //    else
                //        dRainfallO = Double.Parse(itemsO[1]);

                //    if (itemsO[2].Length == 0)
                //        dInfiltrationO = PointPair.Missing;
                //    else
                //        dInfiltrationO = Double.Parse(itemsO[2]);

                //    if (itemsO[3].Length == 0)
                //        dAETO = PointPair.Missing;
                //    else
                //        dAETO = Double.Parse(itemsO[3]);

                //    if (itemsO[4].Length == 0)
                //        dDrainageO = PointPair.Missing;
                //    else
                //        dDrainageO = Double.Parse(itemsO[4]);

                //    if (itemsO[5].Length == 0)
                //        dRunoffO = PointPair.Missing;
                //    else
                //        dRunoffO = Double.Parse(itemsO[5]);

                //    if (itemsO[6].Length == 0)
                //        dSEWO = PointPair.Missing;
                //    else
                //        dSEWO = Double.Parse(itemsO[6]);

                //    if (itemsO[7].Length == 0)
                //        dWaterLossO = PointPair.Missing;
                //    else
                //        dWaterLossO = Double.Parse(itemsO[7]);

                //    if (itemsO[8].Length == 0)
                //        dPumpVolO = PointPair.Missing;
                //    else
                //        dPumpVolO = Double.Parse(itemsO[8]);
                ...
                //    //Then do Zedgraph XDate
                //    XDate myXDateO = new XDate(iYear, iMonth, iDay);
                //    Double dDateO = myXDateO;
                //    //XDate myXDateMonth = new XDate(iYear, iMonth, iDay);
                //    //Double dDateMonth = myXDateMonth;
                //    //double dYearlyYear = dYear;

                //    //Add Daily Values to Daily Lists
                //    Obs1List.Add(dDateO, dRainfallO);
                //    Obs2List.Add(dDateO, dInfiltrationO);
                //    Obs3List.Add(dDateO, dAETO);
                ...
                ////Test for existing Observed Data Plots

                //if (File.Exists("graphing/Observed_Paths.dat"))
                //{
                ...
                ////Handle if files do not exists
                //if (File.Exists("graphing/Observed_Prefs1"))
                //{
                //    //Read in Observed_Prefs1.dat
                //    methodLoadObservedPrefs1();
                //    //Update if Plot Displayed and Type
            ...
            #region "Catch Errors to this point"

            //catch (Exception ex)
            //{

            //    MessageBox.Show("Whoops! An error has occurred.  It is labeled \n\n"
            //          + ex.Message + ".err" + "\n\n"
            //          + "It is located in the DRAINMOD/graphing folder \n\n"
            ...
            //    using (StreamWriter swERR = new StreamWriter("graphing/" + ex.Message + ".err"))
            //    {
            ...
            #region "Load Preference 1 dat files - Visible Settings"
            ...
            if (File.Exists(sFileHydrology_Prefs1))
            {
                ...
                methodDisplaySurfaceRunoff();
                methodDisplayWaterLoss();
                //Update Axis - Has checks to return if no obs file/list loaded
                methodChangeAxis(); 
            }
            ...
            if (File.Exists(sFileObserved_Prefs1))
            {
                //Read in Observed_Prefs1.dat - Has checks to do nothing if no obs file/list loaded
                methodLoadObservedPrefs1();
                //Update if Plot Displayed and Type - Has checks to return if no obs file/list loaded
                methodDisplayObs1();
                methodDisplayObs2();
                methodDisplayObs3();
                //Update Axis - Has checks to return if no obs file/list loaded
            ...
            //Make sure empty observed sets have checkbox set to false
            if (this.textObsFile.Text == "")
            {
                this.checkObsWT1.Checked = false;
            }
        ...
        #region "Button - Reload Graph Data from New DRAINMOD Run - Calls Major Load"
        ...
        private void reloadDataToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show("The datasets have been updated", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }

            catch (Exception ex)
            {
                MessageBox.Show("An error has occurred.  It is labeled \n\n"
                      + ex.Message + ".err" + "\n\n"
                      + "It is located in the DRAINMOD/graphing folder \n\n"
                      + "And has the following information:\n\n" + ex.Message + "\n" + ex.Source + "\n" + ex.StackTrace + "\n\n"
                      + "Please email this file to brian_phillips@ncsu.edu",
                 "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop);
        ...
        //*************************************************
        //*************************************************
        //Load in and Apply Formatting
        //*************************************************


        #region "methodLoadFormattingScheme - Plot Formatting of Non Visible Options"
        ...
        private void methodLoadFormattingScheme()
        {
            ...
            if (File.Exists(sFileXAxis))
            {
                ...
                string sXAxisScaleFormat = prefs002.ReadLine();
                switch (sXAxisScaleFormat)
                {
                    case "dd-M-yyyy":
                        zg1.GraphPane.XAxis.Scale.Format = "dd-M-yyyy";
                        break;
                    case "dd-MMM-yyyy":
                        zg1.GraphPane.XAxis.Scale.Format = "dd-MMM-yyyy";
                        break;

                    case "y":
                        zg1.GraphPane.XAxis.Scale.Format = "y";
                        break;
                    case "dd-MMM":
                        zg1.GraphPane.XAxis.Scale.Format = "dd-MMM";
                        break;
                    case "yyyy":
                        zg1.GraphPane.XAxis.Scale.Format = "yyyy";
                        break;
                    default:
                        break;
        ...
        #region "methodLoad***Prefs1 - Plot Formatting of Visible Options"
        ...
        public void methodLoadObservedPrefs1()
        {
            ...
            //Label
            stextObs1Label = stmReader01.ReadLine();
            this.textObs1Label.Text = stextObs1Label;
            //if (this.textObsFile.Text != "")
            //{
            //    myBarObs.Label.Text = stextObs1Label;
            //    myCurveObs.Label.Text = stextObs1Label;
            //}
            ...
            //Label
            stextObs2Label = stmReader01.ReadLine();
            this.textObs2Label.Text = stextObs2Label;
            //if (this.textObsFile2.Text != "")
            //{
            //    myBarObs2.Label.Text = stextObs2Label;
            //    myCurveObs2.Label.Text = stextObs2Label;
            //}
            ...
            //Label
            stextObs3Label = stmReader01.ReadLine();
            this.textObs3Label.Text = stextObs3Label;
            //if (this.textObsFile3.Text != "")
            //{
            //    myBarObs3.Label.Text = stextObs3Label;
            //    myCurveObs3.Label.Text = stextObs3Label;
            //}
            //Plot Type Index value
        ...
        //***********************************************************************
        //***********************************************************************
        //Re-Load in and Re-Apply Formatting after Preference Form sets changes
        //***********************************************************************

        #region "FINISH****Read in Cancel.dat file and handle if updates needed"
        ...
        //***********************************************************************
        //***********************************************************************
        //Runtime Changes to Visible Plot Options - Checkboxes, Plot Types, Etc..
        //***********************************************************************
        ...
        //***********************************************************************
        //***********************************************************************
        //Runtime Changes Observed Data Files
        //***********************************************************************
            ...
            private void buttonOpenObs1_Click(object sender, EventArgs e)
            {
                ...
                {
                    //Skip feedback if user clicks cancel button
               ...
               // zg1.AxisChange();
                ...
                //Try to load in observed file if proper format
                try
                {
                    ...
                    while ((line = inObserved.ReadLine()) != null)
                    {
                        ...
                        //If top line is header, cycle
                        if (items[0].Equals("Date")) continue;
                    ...
                    //LineItem myCurveObs;
                    myCurveObs = myPane.AddCurve("Observed Data File 1", ObsWTList, Color.Black);
                    myBarObs = myPane.AddBar("Observed Data File 1", ObsWTList, Color.Black);

                    myCurveObs.Label.Text = this.textObs1Label.Text;
                    myBarObs.Label.Text = this.textObs1Label.Text;
                    ...
                    //Save Visible Settings with newly added observed file
                    methodCallSavers1();

                    //Call Formatting method
                    methodLoadFormattingScheme();

                    //File List For Further Formatting
                    string sFileObserved_Prefs1 = "Graphing/Observed_Prefs1.dat";
                ...
                {
                    MessageBox.Show("The observed data files were not in the proper format." +
                        "\n\nPlease see Help > Observed File Format.",
                        "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    this.textObsFile.Text = "";
                    return;
            ...
            private void buttonOpenObs2_Click(object sender, EventArgs e)
            {
                ...
                try
                {
                    ...
                    myCurveObs2 = myPane.AddCurve("Observed Date File 2",
                       ObsWTList2, Color.Purple);
                    myBarObs2 = myPane.AddBar("Observed Data File 2",
                        ObsWTList2, Color.Red);

                    myCurveObs2.Label.Text = this.textObs2Label.Text;
                    myBarObs2.Label.Text = this.textObs2Label.Text;
            ...
            private void buttonOpenObs3_Click(object sender, EventArgs e)
            {
                ...
                try
                {
                    ...
                    // symbols, and "Z" in the legend
                    //LineItem myCurveObs;
                    myCurveObs3 = myPane.AddCurve("Observed Date File 3",
                       ObsWTList3, Color.RoyalBlue);
                    myBarObs3 = myPane.AddBar("Observed Data File 3",
                        ObsWTList3, Color.Red);

                    myCurveObs3.Label.Text = this.textObs3Label.Text;
                    myBarObs3.Label.Text = this.textObs3Label.Text;
        ...
        //***********************************************************************
        //***********************************************************************
        //Apply some Runtime with Update Button
        //*********************************************************************** 
        ...
        //***********************************************************************
        //***********************************************************************
        //Preference Window caller and Specify which node to open
        //*********************************************************************** 
        ...
        #region " Buttons - Format Plot Area Menu Option"
        ...
        #region "Buttons - Format Hydrology and Observed Data Buttons"
        ...
        #region "Call all Visible Options Savers"

            private void methodCallSavers1()
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);

                methodSaveToPreference1();
                methodSaveToHydrology_Prefs1();
                methodObservedFilePath();
                methodSaveToObserved_Prefs1();
        ...
        #region "Save to Number 1 DAT file Method"
            ...
            public void methodSaveToHydrology_Prefs1()
            {
                ...
                using (StreamWriter sw07 = new StreamWriter("Graphing/Hydrology_Prefs1.dat"))
                {
                    ...
                    //Is Displayed
                    sw07.WriteLine(Convert.ToString(this.checkDrainage.Checked));
                    //Is on Secondary Axis
                    if (this.checkDrainageSec.Checked == true)
                    {
                        sw07.WriteLine("Secondary");
                    }
                    else
                    ...
                    //Plot Type Index Value
                    sw07.WriteLine(Convert.ToString(this.comboTypeDrainage.SelectedItem));
        ...
        #region "Startup Preference Window"
        ...
        //***********************************************************************
        //***********************************************************************
        //Methods to Handle Changes to Plot when data loaded in
        //*********************************************************************** 
        ...
        #region "Onload - Load in Observed Files - Creates Lists"

            private void methodLoadInObserved1()
            {
                if (this.textObsFile.Text != "" && sOnLoad != "YES")
                {
                    classClearListObs1();
                }
            ...
            {
                if (this.textObsFile2.Text != "" && sOnLoad != "YES")
                {
                    classClearListObs2();
                }
            ...
            {
                if (this.textObsFile3.Text != "" && sOnLoad != "YES")
                {
                    classClearListObs3();
                }
        ...
        //******************************************************************************
        //******************************************************************************
        //Error handling - Create Preference files and directory if they do not exists
        //****************************************************************************** 


      #region "Generate Files if they do not exists"

  
            private void methodCreateFile()
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
                ...
                try
                {
                    ...
                    create_files create_files = new create_files();

                    string ssFileGeneral = "Graphing/General.dat";
                    string ssFileXAxis = "Graphing/XAxis.dat";
                    string ssFilePrimaryYAxis = "Graphing/PrimaryYAxis.dat";
                    string ssFileSecondaryYAxis = "Graphing/SecondaryYAxis.dat";
                    string ssFileObservedFile1 = "Graphing/ObservedFile1.dat";
                    string ssFileObservedFile2 = "Graphing/ObservedFile2.dat";
                    string ssFileObservedFile3 = "Graphing/ObservedFile3.dat";
                    string ssFileWaterTable = "Graphing/WaterTableDepth.dat";
                    string ssFileDryZone = "Graphing/DryZoneDepth.dat";
                    string ssFileDrainage = "Graphing/Drainage.dat";
                    string ssFileEvaporation = "Graphing/Evaporation.dat";
                    string ssFileInfiltration = "Graphing/Infiltration.dat";
                    string ssFileSurfaceStorage = "Graphing/SurfaceStorage.dat";
                    string ssFileSurfaceRunoff = "Graphing/SurfaceRunoff.dat";
                    string ssFileRainfall = "Graphing/Rainfall.dat";
                    string ssFileWaterLoss = "Graphing/WaterLoss.dat";
                    string ssPreferences1 = "Graphing/Preference1.dat";
                    string ssHydrology_Prefs1 = "Graphing/Hydrology_Prefs1.dat";
                    string ssObserved_Prefs1 = "Graphing/Observed_Prefs1.dat";
                    string sCSV_Options = "Graphing/CSV_Options.dat";

                    string ssDaily = "Graphing/StartupD.dat";
                    string ssMonthly = "Graphing/StartupM.dat";
                    string ssYearly = "Graphing/StartupY.dat";

                    if (File.Exists(sCSV_Options))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesCSV_Options();
                    }
                    ...
                    {
                        create_files.methodCreateCancelFile();
                    }

                    if (File.Exists(ssFileGeneral))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileGeneral();
                    }
                    if (File.Exists(ssFileXAxis))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileXAxis();
                    }
                    if (File.Exists(ssFilePrimaryYAxis))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFilePrimaryY();
                    }

                    if (File.Exists(ssFileSecondaryYAxis))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileSecondaryY();
                    }
                    if (File.Exists(ssFileObservedFile1))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileObservedFile1();
                    }
                    if (File.Exists(ssFileObservedFile2))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileObservedFile2();
                    }
                    if (File.Exists(ssFileObservedFile3))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileObservedFile3();
                    }
                    if (File.Exists(ssFileWaterTable))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileWaterTable();
                    }
                    if (File.Exists(ssFileDryZone))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileDryZone();
                    }
                    if (File.Exists(ssFileDrainage))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileDrainage();
                    }
                    if (File.Exists(ssFileEvaporation))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileEvaporation();
                    }
                    if (File.Exists(ssFileInfiltration))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileInfiltration();
                    }
                    if (File.Exists(ssFileSurfaceStorage))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileSurfaceStorage();
                    }
                    if (File.Exists(ssFileSurfaceRunoff))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileSurfaceRunoff();
                    }
                    if (File.Exists(ssFileRainfall))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileRainfall();
                    }
                    if (File.Exists(ssFileWaterLoss))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesFileWaterLoss();
                    }
                    if (File.Exists(ssPreferences1))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesPreferences1();
                    }
                    if (File.Exists(ssHydrology_Prefs1))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesHydrology_Prefs1();
                    }
                    if (File.Exists(ssObserved_Prefs1))
                    {

                    }
                    else
                    {
                        create_files.methodCreatesObserved_Prefs1();
                    }

                    if (File.Exists(ssDaily))
                    {

                    }
                    else
                    {
                        create_files.methodCreateDaily();
                    }
                    if (File.Exists(ssMonthly))
                    {

                    }
                    else
                    {
                        create_files.methodCreateMonthly();
                    }
                    if (File.Exists(ssYearly))
                    {

                    }
                    else
                    {
                        create_files.methodCreateYearly();
                    }
                ...
                {
                    MessageBox.Show("You are missing some of the format FileShare\n\nUnable to create those files at this time\n\n Please click Reset Format Files > All");
                    return;
                }
        ...
        //******************************************************************************
        //******************************************************************************
        //Menu Items, Contect Menus, Etc...
        //******************************************************************************


       #region "Menus, Context Menu and Others Non Graphing"
        ...
        #region "CSV Exporting"
            ...
            private void ShowSaveAsForExportCSV(object sender, System.EventArgs e)
            {
                try
                {
                    csv_export_variables frmCSV = new csv_export_variables();

                    frmCSV.ShowDialog(this);
                    ...
                    //Instantiate reader
                    StreamReader stmReader10101 = new StreamReader("Graphing/CSV_Options.dat");

                    sSaveToCSV = stmReader10101.ReadLine();
                    stmReader10101.ReadLine();
                    bool bcheckPreWTbool = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckDryZoneDepth = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckSurfaceStorage = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckRainfall = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckInfiltration = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckEvaporation = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckDrainage = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckSurfaceRunoff = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckWaterLoss = Convert.ToBoolean(stmReader10101.ReadLine());
                    stmReader10101.ReadLine();
                    bool bcheckMonthlyRainfall = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckMonthlyInfiltration = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckMonthlyEvaporation = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckMonthlyDrainage = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckMonthlySurfaceRunoff = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckMonthlyWaterLoss = Convert.ToBoolean(stmReader10101.ReadLine());
                    stmReader10101.ReadLine();
                    bool bcheckYearlyRainfall = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckYearlyInfiltration = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckYearlyEvaporation = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckYearlyDrainage = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckYearlySurfaceRunoff = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckYearlyWaterLoss = Convert.ToBoolean(stmReader10101.ReadLine());
                    stmReader10101.ReadLine();
                    bool bcheckCumulativeRainfall = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckCumulativeInfiltration = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckCumulativeEvaporation = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckCumulativeDrainage = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckCumulativeSurfaceRunoff = Convert.ToBoolean(stmReader10101.ReadLine());
                    bool bcheckCumulativeWaterLoss = Convert.ToBoolean(stmReader10101.ReadLine());


                    //Clean up and close file
                    stmReader10101.Close();
                    stmReader10101.Dispose();

                    if (sSaveToCSV == "Cancel")
                        return;
                    else
                    {
                        if (bcheckPreWTbool || bcheckDryZoneDepth || bcheckSurfaceStorage ||
                            bcheckRainfall || bcheckInfiltration || bcheckEvaporation ||
                            bcheckDrainage || bcheckSurfaceRunoff || bcheckWaterLoss)
                        {
                            //show saveAs CmdDlg
                            saveFileDialog1.Filter = "CSV files (*.csv)|*.csv";
                            saveFileDialog1.Title = "Save Daily CSV File";
                            saveFileDialog1.ShowDialog();
                            m_CSVWriter = new StreamWriter(saveFileDialog1.FileName);
                            //WriteCSVToStream();

                            //First line is for Headers., X and Y Axis
                            string _xAxisHeader = "Date";
                            //string _yAxisHeader = CheckCSVString(zg1.GraphPane.YAxis.Title.Text);
                            //m_CSVWriter.Write(_xAxisHeader + "," + _yAxisHeader + "\n");
                            m_CSVWriter.Write(_xAxisHeader + ",");

                            if (bcheckPreWTbool)
                            {
                                m_CSVWriter.Write("Water Table Depth" + ",");
                            }
                            if (bcheckDryZoneDepth)
                            {
                                m_CSVWriter.Write("Dry Zone Depth" + ",");
                            }
                            if (bcheckSurfaceStorage)
                            {
                                m_CSVWriter.Write("Surface Storage" + ",");
                            }
                            if (bcheckRainfall)
                            {
                                m_CSVWriter.Write("Rainfall" + ",");
                            }
                            if (bcheckInfiltration)
                            {
                                m_CSVWriter.Write("Infiltration" + ",");
                            }
                            if (bcheckEvaporation)
                            {
                                m_CSVWriter.Write("Evaporation" + ",");
                            }
                            if (bcheckDrainage)
                            {
                                m_CSVWriter.Write("Drainage" + ",");
                            }
                            if (bcheckSurfaceRunoff)
                            {
                                m_CSVWriter.Write("Surface Runoff" + ",");
                            }
                            if (bcheckWaterLoss)
                            {
                                m_CSVWriter.Write("Water Loss" + ",");
                            }
                            m_CSVWriter.Write("\n");
                            ...
                            {
                                m_CSVWriter.Write(PreWTList[i].X + ",");

                                if (bcheckPreWTbool)
                                {
                                    m_CSVWriter.Write(PreWTList[i].Y + ",");
                                }
                                if (bcheckDryZoneDepth)
                                {
                                    m_CSVWriter.Write(DryZoneList[i].Y + ",");
                                }
                                if (bcheckSurfaceStorage)
                                {
                                    m_CSVWriter.Write(SurfaceStorageList[i].Y + ",");
                                }
                                if (bcheckRainfall)
                                {
                                    m_CSVWriter.Write(RainfallList[i].Y + ",");
                                }
                                if (bcheckInfiltration)
                                {
                                    m_CSVWriter.Write(InfiltrationList[i].Y + ",");
                                }
                                if (bcheckEvaporation)
                                {
                                    m_CSVWriter.Write(AETList[i].Y + ",");
                                }
                                if (bcheckDrainage)
                                {
                                    m_CSVWriter.Write(DrainageList[i].Y + ",");
                                }
                                if (bcheckSurfaceRunoff)
                                {
                                    m_CSVWriter.Write(RunoffList[i].Y + ",");
                                }
                                if (bcheckWaterLoss)
                                {
                                    m_CSVWriter.Write(WaterLossList[i].Y + ",");
                                }
                                m_CSVWriter.Write("\n");
                        ...
                        if (bcheckMonthlyRainfall || bcheckMonthlyInfiltration || bcheckMonthlyEvaporation ||
                             bcheckMonthlyDrainage || bcheckMonthlySurfaceRunoff || bcheckMonthlyWaterLoss)
                        {
                            Thread.Sleep(500);

                            //show saveAs CmdDlg
                            saveFileDialog1.Filter = "CSV files (*.csv)|*.csv";
                            saveFileDialog1.Title = "Save Monthly CSV File";
                            saveFileDialog1.ShowDialog();
                            m2_CSVWriter = new StreamWriter(saveFileDialog1.FileName);
                            //WriteCSVToStream();

                            //First line is for Headers., X and Y Axis
                            string _xAxisHeader = "Date";
                            //string _yAxisHeader = CheckCSVString(zg1.GraphPane.YAxis.Title.Text);
                            //m2_CSVWriter.Write(_xAxisHeader + "," + _yAxisHeader + "\n");
                            m2_CSVWriter.Write(_xAxisHeader + ",");

                            if (bcheckMonthlyRainfall)
                            {
                                m2_CSVWriter.Write("Rainfall" + ",");
                            }
                            if (bcheckMonthlyInfiltration)
                            {
                                m2_CSVWriter.Write("Infiltration" + ",");
                            }
                            if (bcheckMonthlyEvaporation)
                            {
                                m2_CSVWriter.Write("Evaporation" + ",");
                            }
                            if (bcheckMonthlyDrainage)
                            {
                                m2_CSVWriter.Write("Drainage" + ",");
                            }
                            if (bcheckMonthlySurfaceRunoff)
                            {
                                m2_CSVWriter.Write("Surface Runoff" + ",");
                            }
                            if (bcheckMonthlyWaterLoss)
                            {
                                m2_CSVWriter.Write("Water Loss" + ",");
                            }
                            m2_CSVWriter.Write("\n");


                            //subsequent lines are having data
                            for (int i = 0; i < MonthlyRainfallList.Count; i++)
                            {
                                m2_CSVWriter.Write(MonthlyRainfallList[i].X + ",");

                                if (bcheckMonthlyRainfall)
                                {
                                    m2_CSVWriter.Write(MonthlyRainfallList[i].Y + ",");
                                }
                                if (bcheckMonthlyInfiltration)
                                {
                                    m2_CSVWriter.Write(MonthlyInfiltrationList[i].Y + ",");
                                }
                                if (bcheckMonthlyEvaporation)
                                {
                                    m2_CSVWriter.Write(MonthlyAETList[i].Y + ",");
                                }
                                if (bcheckMonthlyDrainage)
                                {
                                    m2_CSVWriter.Write(MonthlyDrainageList[i].Y + ",");
                                }
                                if (bcheckMonthlySurfaceRunoff)
                                {
                                    m2_CSVWriter.Write(MonthlyRunoffList[i].Y + ",");
                                }
                                if (bcheckMonthlyWaterLoss)
                                {
                                    m2_CSVWriter.Write(MonthlyWaterLossList[i].Y + ",");
                                }
                                m2_CSVWriter.Write("\n");
                            ...
                            m2_CSVWriter.Close();
                            m2_CSVWriter.Dispose();



                        }//Close IF Monthly Loop


                        if (bcheckYearlyRainfall || bcheckYearlyInfiltration || bcheckYearlyEvaporation ||
                             bcheckYearlyDrainage || bcheckYearlySurfaceRunoff || bcheckYearlyWaterLoss)
                        {
                            Thread.Sleep(500);

                            //show saveAs CmdDlg
                            saveFileDialog1.Filter = "CSV files (*.csv)|*.csv";
                            saveFileDialog1.Title = "Save Yearly CSV File";
                            saveFileDialog1.ShowDialog();
                            m3_CSVWriter = new StreamWriter(saveFileDialog1.FileName);
                            //WriteCSVToStream();

                            //First line is for Headers., X and Y Axis
                            string _xAxisHeader = "Date";
                            //string _yAxisHeader = CheckCSVString(zg1.GraphPane.YAxis.Title.Text);
                            //m3_CSVWriter.Write(_xAxisHeader + "," + _yAxisHeader + "\n");
                            m3_CSVWriter.Write(_xAxisHeader + ",");

                            if (bcheckYearlyRainfall)
                            {
                                m3_CSVWriter.Write("Rainfall" + ",");
                            }
                            if (bcheckYearlyInfiltration)
                            {
                                m3_CSVWriter.Write("Infiltration" + ",");
                            }
                            if (bcheckYearlyEvaporation)
                            {
                                m3_CSVWriter.Write("Evaporation" + ",");
                            }
                            if (bcheckYearlyDrainage)
                            {
                                m3_CSVWriter.Write("Drainage" + ",");
                            }
                            if (bcheckYearlySurfaceRunoff)
                            {
                                m3_CSVWriter.Write("Surface Runoff" + ",");
                            }
                            if (bcheckYearlyWaterLoss)
                            {
                                m3_CSVWriter.Write("Water Loss" + ",");
                            }
                            m3_CSVWriter.Write("\n");


                            //subsequent lines are having data
                            for (int i = 0; i < YearlyRainfallList.Count; i++)
                            {
                                m3_CSVWriter.Write(YearlyRainfallList[i].X + ",");

                                if (bcheckYearlyRainfall)
                                {
                                    m3_CSVWriter.Write(YearlyRainfallList[i].Y + ",");
                                }
                                if (bcheckYearlyInfiltration)
                                {
                                    m3_CSVWriter.Write(YearlyInfiltrationList[i].Y + ",");
                                }
                                if (bcheckYearlyEvaporation)
                                {
                                    m3_CSVWriter.Write(YearlyAETList[i].Y + ",");
                                }
                                if (bcheckYearlyDrainage)
                                {
                                    m3_CSVWriter.Write(YearlyDrainageList[i].Y + ",");
                                }
                                if (bcheckYearlySurfaceRunoff)
                                {
                                    m3_CSVWriter.Write(YearlyRunoffList[i].Y + ",");
                                }
                                if (bcheckYearlyWaterLoss)
                                {
                                    m3_CSVWriter.Write(YearlyWaterLossList[i].Y + ",");
                                }
                                m3_CSVWriter.Write("\n");
                            ...
                            m3_CSVWriter.Close();
                            m3_CSVWriter.Dispose();



                        }//Close IF Yearly Loop

                        if (bcheckCumulativeRainfall || bcheckCumulativeInfiltration || bcheckCumulativeEvaporation ||
                             bcheckCumulativeDrainage || bcheckCumulativeSurfaceRunoff || bcheckCumulativeWaterLoss)
                        {
                            Thread.Sleep(500);

                            //show saveAs CmdDlg
                            saveFileDialog1.Filter = "CSV files (*.csv)|*.csv";
                            saveFileDialog1.Title = "Save Cumulative CSV File";
                            saveFileDialog1.ShowDialog();
                            m4_CSVWriter = new StreamWriter(saveFileDialog1.FileName);
                            //WriteCSVToStream();

                            //First line is for Headers., X and Y Axis
                            string _xAxisHeader = "Date";
                            //string _yAxisHeader = CheckCSVString(zg1.GraphPane.YAxis.Title.Text);
                            //m4_CSVWriter.Write(_xAxisHeader + "," + _yAxisHeader + "\n");
                            m4_CSVWriter.Write(_xAxisHeader + ",");

                            if (bcheckCumulativeRainfall)
                            {
                                m4_CSVWriter.Write("Rainfall" + ",");
                            }
                            if (bcheckCumulativeInfiltration)
                            {
                                m4_CSVWriter.Write("Infiltration" + ",");
                            }
                            if (bcheckCumulativeEvaporation)
                            {
                                m4_CSVWriter.Write("Evaporation" + ",");
                            }
                            if (bcheckCumulativeDrainage)
                            {
                                m4_CSVWriter.Write("Drainage" + ",");
                            }
                            if (bcheckCumulativeSurfaceRunoff)
                            {
                                m4_CSVWriter.Write("Surface Runoff" + ",");
                            }
                            if (bcheckCumulativeWaterLoss)
                            {
                                m4_CSVWriter.Write("Water Loss" + ",");
                            }
                            m4_CSVWriter.Write("\n");


                            //subsequent lines are having data
                            for (int i = 0; i < CumulativeRainfallList.Count; i++)
                            {
                                m4_CSVWriter.Write(CumulativeRainfallList[i].X + ",");

                                if (bcheckCumulativeRainfall)
                                {
                                    m4_CSVWriter.Write(CumulativeRainfallList[i].Y + ",");
                                }
                                if (bcheckCumulativeInfiltration)
                                {
                                    m4_CSVWriter.Write(CumulativeInfiltrationList[i].Y + ",");
                                }
                                if (bcheckCumulativeEvaporation)
                                {
                                    m4_CSVWriter.Write(CumulativeAETList[i].Y + ",");
                                }
                                if (bcheckCumulativeDrainage)
                                {
                                    m4_CSVWriter.Write(CumulativeDrainageList[i].Y + ",");
                                }
                                if (bcheckCumulativeSurfaceRunoff)
                                {
                                    m4_CSVWriter.Write(CumulativeRunoffList[i].Y + ",");
                                }
                                if (bcheckCumulativeWaterLoss)
                                {
                                    m4_CSVWriter.Write(CumulativeWaterLossList[i].Y + ",");
                                }
                                m4_CSVWriter.Write("\n");
                            ...
                            m4_CSVWriter.Close();
                            m4_CSVWriter.Dispose();



                        }//Close IF Cumulative Loop
                    ...
                    if (bcheckPreWTbool || bcheckDryZoneDepth || bcheckSurfaceStorage ||
                            bcheckRainfall || bcheckInfiltration || bcheckEvaporation ||
                            bcheckDrainage || bcheckSurfaceRunoff || bcheckWaterLoss ||
                            bcheckMonthlyRainfall || bcheckMonthlyInfiltration || bcheckMonthlyEvaporation ||
                            bcheckMonthlyDrainage || bcheckMonthlySurfaceRunoff || bcheckMonthlyWaterLoss ||
                        bcheckYearlyRainfall || bcheckYearlyInfiltration || bcheckYearlyEvaporation ||
                         bcheckYearlyDrainage || bcheckYearlySurfaceRunoff || bcheckYearlyWaterLoss ||
                         bcheckCumulativeRainfall || bcheckCumulativeInfiltration || bcheckCumulativeEvaporation ||
                     bcheckCumulativeDrainage || bcheckCumulativeSurfaceRunoff || bcheckCumulativeWaterLoss)
                    {
                        MessageBox.Show("CSV File(s) Saved", "DRAINMOD Graphing", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
            ...
            #region "Menu - Save Image"


            private void exportPlotImageToolStripMenuItem1_Click(object sender, EventArgs e)
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
            ...
            #region "Menu - Copy to Clipboard"

            private void copyImageToClipboardToolStripMenuItem_Click(object sender, EventArgs e)
            {
                CopyToClip(zg1.GraphPane);
            }

            #endregion


            #region "Menu - Export CSV Data"
            ...
            private void ExportDataMenu_Click(object sender, EventArgs e)
            {
                try
                {
                    ...
                    else
                    {
                            ...
                            bcheckDrainage || bcheckSurfaceRunoff || bcheckWaterLoss)
                        {
                            ...
                            {
                                //Write Date
                                //TODO - Make date write as mm/dd/yy format
                                //m_CSVWriter.Write(PreWTList[i].X );
                                //var dateToConvert = DateTimeConverter (PreWTList[i].X);
                                m_CSVWriter.Write(csvDateList[i]);
                             ...
                             bcheckMonthlyDrainage || bcheckMonthlySurfaceRunoff || bcheckMonthlyWaterLoss)
                        {
                            ...
                            for (int i = 0; i < MonthlyRainfallList.Count; i++)
                            {
                                var dateTime = DateTime.FromOADate(MonthlyRainfallList[i].X);

                            //m2_CSVWriter.Write(MonthlyRainfallList[i].X);

                            m2_CSVWriter.Write(dateTime.ToString("MM/yyyy"));
                            if (bcheckMonthlyRainfall)
                                {
                                    m2_CSVWriter.Write("," + MonthlyRainfallList[i].Y);
                                }
                             ...
                             bcheckYearlyDrainage || bcheckYearlySurfaceRunoff || bcheckYearlyWaterLoss)
                        {
                            ...
                            var dateTime = DateTime.FromOADate(YearlyRainfallList[i].X);

                            //m2_CSVWriter.Write(MonthlyRainfallList[i].X);

                            m3_CSVWriter.Write(dateTime.ToString("yyyy"));
                ...
                {
                    MessageBox.Show("An error occurred while saving your CSV file.", "DRAINMOD Graphing", MessageBoxButtons.OK,MessageBoxIcon.Error);
                    return;
                }
            ...
            private void menuUpdate_Click(object sender, EventArgs e)
            {
                ...
                {
                    MessageBox.Show("The required update.exe was not found" +
                                    "Please check website for updates", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
            ...
            //    string url = "http://www.bae.ncsu.edu/soil_water/drainmod/download.html";
            //    try
            //    {
            //        // provide the XmlTextReader with the URL of
            //        // our xml document
            //        string xmlURL = "http://www.bae.ncsu.edu/soil_water/drainmod/updates/drainmod_graphing_update.xml";
            ...
            #region "Menu - Contact Author"

            private void contactAuthorToolStripMenuItem_Click(object sender, EventArgs e)
            {


                System.Diagnostics.Process.Start("http://www.bae.ncsu.edu/soil_water/contact.html");
            ...
            #region "Menu - DRAINMOD Website"

            private void dRAINMODWebsiteToolStripMenuItem_Click(object sender, EventArgs e)
            {
                System.Diagnostics.Process.Start("http://www.bae.ncsu.edu/soil_water/drainmod/index.html");
            }
            ...
            private void aboutTheUtilityToolStripMenuItem_Click(object sender, EventArgs e)
            {
                ...
                ZedGraphControl.ContextMenuObjectState objState)
            {
                ...
                // This is the user-defined Tag so you can find this menu item later if necessary
                _item2.Name = "Export HQ Image to Clipboard";
                _item2.Tag = "export_hq_clipboard";
                // This is the text that will show up in the menu
                _item2.Text = "Export HQ Image to Clipboard";
                // Add a handler that will respond when that menu item is selected
                _item2.Click += new System.EventHandler(methodInvokeCopyToClip);
                // Add the menu item to the menu,as 2nd Item
                menuStrip.Items.Insert(1, _item2);
            ...
            private void buttonHelp_Click(object sender, EventArgs e)
            {
                try
                {
                    System.Diagnostics.Process.Start("drainmod6.chm");
                }
                catch
                {
                    MessageBox.Show("The required drainmod.chm Help File was not found" +
                "\n\nPlease check website for updates", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
            ...
            #region "Observed Format Help Button"

            private void   buttonObservedHelp_Click(object sender, EventArgs e)
            {

                System.Diagnostics.Process.Start("Observed_Data_Format_For_Graph.rtf");
            ...
            #region "Save Current Formatting"

            private void saveCurrentFormattingToolStripMenuItem_Click(object sender, EventArgs e)
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
                ...
                MessageBox.Show("The current formatting scheme has been saved", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
       ...
       #region "Statistics"
            ...
            #region "In Form Statistical Methods"
            ...
            private void buttonCalculateStats_Click(object sender, EventArgs e)
            {
                ...
                try
                {
                    ...
                    double dRMSEDiff = 0;
                        ...
                        double dMeanObservedSum = 0;
                        double dMeanObserved = 0;
                        //string saY = "";
                        //string sbY = "";
                        ...
                        //Check for number of overlapping dates between two sets
                        //This will define sample size

                        //Instantiate Y Variable Lists - for R^2 and E calcs
                        ...
                        for (int i = 1; i <= Variable1aList.Count; i++)
                        {
                            ...
                            {
                                //saY = Convert.ToString(Variable1aList[i - 1].Y);
                                //sbY = Convert.ToString(Variable1bList[j - 1].Y);

                                if (Variable1bList[j - 1].X == Variable1aList[i - 1].X && Math.Abs(Variable1aList[i - 1].Y) < 1E5 && Math.Abs(Variable1bList[j - 1].Y) < 1E5)
                                {
                                    //saY = Convert.ToString(Variable1aList[i - 1].Y);
                                    //sbY = Convert.ToString(Variable1bList[j - 1].Y);
                                    //MessageBox.Show(saY + "," + sbY , "Test", MessageBoxButtons.OK, MessageBoxIcon.Error);

                                    //Determine List Size
                                    dSampleSizeGroup1 = dSampleSizeGroup1 + 1;
                                    //Sum Absolute differences
                                    dAbsDiffGroup1 = dAbsDiffGroup1 + Math.Abs(Variable1bList[j - 1].Y - Variable1aList[i - 1].Y);
                                //Sum Non-Absolute differences for PBIAS
                                dNonAbsDiffGroup1 = dNonAbsDiffGroup1 + Variable1bList[j - 1].Y - Variable1aList[i - 1].Y;
                                //Sum Observed - List A
                                //dMeanObservedSum =   dMeanObservedSum + Math.Abs(Variable1bList[j - 1].Y;
                                //Squared Error for RMSE
                                dRMSEDiff = dRMSEDiff + Math.Pow((Variable1bList[j - 1].Y - Variable1aList[i - 1].Y), 2);
                        ...
                        //MessageBox.Show(Convert.ToString(dSampleSizeGroup1), "Test", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        ...
                        //RMSE
                        dRMSE = Math.Sqrt(dRMSEDiff / dSampleSizeGroup1);
                        this.textRMSE1.Text = Convert.ToString(dRMSE);


                        //Nash-Suttclife Coeffieicnt of Efficiency - E
                        //double[] Variable1Y = Variable1YList.ToArray();
                        double dNashSutcliffe = 1 - (dRMSEDiff / (GetVariance(Variable1aArray)));
                        this.textNash1.Text = Convert.ToString(dNashSutcliffe);

                    //PBIAS
                    double bPBIAS = (1 / dSampleSizeGroup1) * dNonAbsDiffGroup1;
                    this.textBias1.Text = Convert.ToString(bPBIAS);


                    //Dispose of Lists
                    Variable1aList.Clear();
                        Variable1bList.Clear();
                        Variable1YList.Clear();
                        Variable1aArrayList.Clear();
                        Variable1bArrayList.Clear();
                ...
                catch
                {
                    ...
                    MessageBox.Show("An error occurred during calulations of set 1 \n\n Make sure some dates overlap for comparison", "DRAINMOD Graphing - Satistics", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                {
                //If either combo box is empty then bypass stat calcs
                    if (this.comboCompare2a.Text != "" && this.comboCompare2b.Text != "")
                    {

                        // Determine variables selected
                        //A
                        string sVariable1a = this.comboCompare2a.Text;

                        //B
                        string sVariable1b = this.comboCompare2b.Text;
                    ...
                    double dRMSEDiff = 0;
                        ...
                        //Do AAD Calculation
                        dAADGroup1 = dAbsDiffGroup1 / dSampleSizeGroup1;
                        this.textAAD2.Text = (Convert.ToString(dAADGroup1));
                        ...
                        this.textRSquared2.Text = (Convert.ToString(dRSquared1));


                        //RMSE
                        dRMSE = Math.Sqrt(dRMSEDiff / dSampleSizeGroup1);
                        this.textRMSE2.Text = Convert.ToString(dRMSE);


                        //Nash-Suttclife Coeffieicnt of Efficiency - E
                        //double[] Variable1Y = Variable1YList.ToArray();
                        double dNashSutcliffe = 1 - (dRMSEDiff / (GetVariance(Variable1aArray)));
                        this.textNash2.Text = Convert.ToString(dNashSutcliffe);

                    //PBIAS
                    double bPBIAS = (1 / dSampleSizeGroup1) * dNonAbsDiffGroup1;
                    this.textBias2.Text = Convert.ToString(bPBIAS);
                ...
                catch
                {
                    ...
                    MessageBox.Show("An error occurred during calulations of set 2 \n\n Make sure some dates overlap", "DRAINMOD Graphing - Satistics", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                {
                    //If either combo box is empty then bypass stat calcs
                    if (this.comboCompare3a.Text != "" && this.comboCompare3b.Text != "")
                    {

                        // Determine variables selected
                        //A
                        string sVariable1a = this.comboCompare3a.Text;

                        //B
                        string sVariable1b = this.comboCompare3b.Text;
                        ...
                        //Do AAD Calculation
                        dAADGroup1 = dAbsDiffGroup1 / dSampleSizeGroup1;
                        this.textAAD3.Text = (Convert.ToString(dAADGroup1));
                        ...
                        this.textRSquared3.Text = (Convert.ToString(dRSquared1));


                        //RMSE
                        dRMSE = Math.Sqrt(dRMSEDiff / dSampleSizeGroup1);
                        this.textRMSE3.Text = Convert.ToString(dRMSE);


                        //Nash-Suttclife Coeffieicnt of Efficiency - E
                        //double[] Variable1Y = Variable1YList.ToArray();
                        double dNashSutcliffe = 1 - (dRMSEDiff / (GetVariance(Variable1aArray)));
                        this.textNash3.Text = Convert.ToString(dNashSutcliffe);

                    //PBIAS
                        double bPBIAS = (1/dSampleSizeGroup1)*dNonAbsDiffGroup1;
                        this.textBias3.Text = Convert.ToString(bPBIAS);
                ...
                catch
                {
                    ...
                    MessageBox.Show("An error occurred during calulations of set 3 \n\n Make sure some dates overlap", "DRAINMOD Graphing - Satistics", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        #region "Keypress"
            ...
            private void textObs1Label_TextChanged(object sender, EventArgs e)
            {
                if (this.textObsFile.Text != "")
                {
                    myCurveObs.Label.Text = this.textObs1Label.Text;
            ...
            private void textObs2Label_TextChanged(object sender, EventArgs e)
            {
                if (this.textObsFile2.Text != "")
                {
                    myCurveObs2.Label.Text = this.textObs2Label.Text;
            ...
            private void textObs3Label_TextChanged(object sender, EventArgs e)
            {
                if (this.textObsFile3.Text != "")
                {
                    myCurveObs3.Label.Text = this.textObs3Label.Text;
        ...
        #region "Reset Format Files"
            ...
            private void primaryYAxisToolStripMenuItem_Click(object sender, EventArgs e)
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
            ...
            private void observedFilesToolStripMenuItem_Click(object sender, EventArgs e)
            {                   //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
            ...
            private void cSVOptionsToolStripMenuItem_Click(object sender, EventArgs e)
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
            ...
            private void waterTableDepthToolStripMenuItem_Click(object sender, EventArgs e)
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
            ...
            private void dryZoneDepthToolStripMenuItem_Click(object sender, EventArgs e)
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
            ...
            private void surfaceStorageToolStripMenuItem_Click(object sender, EventArgs e)
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
            ...
            private void rainfallToolStripMenuItem_Click(object sender, EventArgs e)
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
            ...
            private void infiltrationToolStripMenuItem_Click(object sender, EventArgs e)
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
            ...
            private void surfaceRunoffToolStripMenuItem_Click(object sender, EventArgs e)
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
            ...
            private void waterLossToolStripMenuItem_Click(object sender, EventArgs e)
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
           ...
           private void evaporationToolStripMenuItem_Click(object sender, EventArgs e)
            {
                //Set path to location of program
                Directory.SetCurrentDirectory(Application.StartupPath);
       ...
       //******************************************************************************
       //******************************************************************************
       //Enhanced metafile to clipboard
       //******************************************************************************

       #region " Enhanced Metafile"

       private void methodInvokeCopyToClip(object sender, System.EventArgs e)
       {
           CopyToClip(zg1.GraphPane);
